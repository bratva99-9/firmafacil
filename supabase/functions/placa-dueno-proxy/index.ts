...
serve(async (req) => {
  ...
  try {
    ...
    const upstreamUrl = `https://www.ecuadorlegalonline.com/modulo/sri/matriculacion/consultar-dueno.php?placa=${encodeURIComponent(placa)}`
    ...
    console.error('Error en placa-dueno-proxy:', err)
